...
# attempting a build.
#
# Install  CCPathnames under  the directory  "/usr/local".  We  assume the
# script is run from the top directory of the build tree.

PROGNAME="${0##*/}"
VERSION=0.4.0-devel.0
STEM="ccpathnames-${VERSION}"
ARCHIVE="${STEM}.tar.gz"
SOURCE_URI="https://github.com/marcomaggi/ccpathnames/archive/v${VERSION}.tar.gz"
